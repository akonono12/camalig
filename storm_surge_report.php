...
<html>
  <head>
    ...
    <title>NDRRMC Tabaco - Barangay List</title>
      ...
      <div class="breadcrumb-holder">   
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="report.php">Flood report</a></li>
			<li class="breadcrumb-item active">Storm Surge Report</li>
                      ...
                      <?php
												...
												if ($result->num_rows > 0) {
													...
													while($row = $result->fetch_assoc()) {
														...
														echo "<td width='300px' style='text-align:center;'>Storm Surge</td><td width='300px' style='text-align:center;'>Signal #".$row['ss_signal']."</td><td width='300px' style='text-align:center;'>".$row['date_added']."</td>";
														$count++;
													}
												} 
												else{
