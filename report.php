      ...
      <div class="breadcrumb-holder">   
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Landslide report</li>
			<li class="breadcrumb-item"><a href="storm_report.php">Storm Report</a></li>
			<li class="breadcrumb-item"><a href="report_graph.php">Report Graph</a></li>
            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header d-flex align-items-center">
                  <h2 class="h5 display">Rain Amount Report for the year <?php echo date('Y');?></h2>
                </div>
                <div class="card-body">
                      ...
                      <?php
												...
												if ($result->num_rows > 0) {
													...
													while($row = $result->fetch_assoc()) {
														...
														echo "<td width='300px' style='text-align:center;'>Landslide</td><td width='300px' style='text-align:center;'>".$row['amount_water']." mm</td><td width='300px' style='text-align:center;'>".$row['date_added']."</td>";
														$count++;
													}
												} 
												else{
