              ...
              <div class="card">
                ...
                <div class="card-body">
                  <table class="table table-striped table-hover">
                    ...
                    <tbody>
                      <?php
												$sql = "SELECT * FROM evacuee_report order by status";
												...
												if ($result->num_rows > 0) {
													...
													while($row = $result->fetch_assoc()) {
														...
														echo "<td width='250px' style='text-align:center;'>".$row['name_head']."</td><td width='250px' style='text-align:center;'>".$row['no_member']."</td><td width='250px' style='text-align:center;'>".$row['status']."</td>";
														echo "<td width='200px' style='text-align:center;'>".$row['date_added']."</td>";
														$count++;
													}
												} 
												else{
