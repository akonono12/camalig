...
<html>
  <head>
    ...
    <title>MDRRMC Camalig - Barangay List</title>
  ...
  <body>
      ...
      <div class="side-navbar-wrapper">
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li  class="active"> <a href="barangay_brgy.php"> <i class="icon-grid"> </i><span>Barangays</span></a></li>
    ...
    <div class="page home-page">
      ...
      <section class="charts" >
        <div class="container-fluid">
          <header> 
            <h1 class="h3">Tabaco City List of Barangays</h1>
          </header>
          <div class="row" style="text-align:center;">
            <div class="col-lg-9">
              <div class="card">
                <div class="card-header d-flex align-items-center">
                  <h2 class="h5 display">List of all Barangay</h2>
                </div>
                <div class="card-body">
                  <table class="table table-striped table-hover">
                    <thead>
                      <tr>
                        <th  width="50px">#</th>
                        <th width="300px" style="text-align:center;">Name of Barangay</th>
                        
                      </tr>
                    </thead>
                    <tbody>
                       <?php
												$sql = "SELECT * FROM barangay order by brgy_id asc";
												...
												if ($result->num_rows > 0) {
													...
													while($row = $result->fetch_assoc()) {
														$brgy=$row['barangay'];
														echo "<tr> <td>".$count."</td>";
														echo "<td width='300px' style='text-align:center;'>".$row['barangay']."</td>";
														$count++;
													}
												} 
												else{
