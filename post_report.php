      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li  class="active"> <a href="post_report.php"> <i class="icon-mail"></i><span>Manage POST</span>
                </a></li>
          </ul>
        </div>
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                <li class="nav-item"><a href="" class="nav-link logout">Welcome <b><?php echo $_SESSION['user_name'];?></b></a></li>
          ...
          <div class="row d-flex align-items-md-stretch">
            ...
            <div class="col-lg-10 col-md-12 flex-lg-last flex-md-first align-self-baseline">
              <div class="wrapper sales-report">
                <h2 class="display h4">MDRRMC Weather Posting Account</h2>
                <p> Weather Post as of <?php echo date("M-d-Y");?></p>
                
				  <div class="col-lg-12">
					<div class="card">
					<form method="POST" action="add_post-script.php">
					<div class="form-group row">
                      <label class="col-sm-6 form-control-label">Amount of Rain</label>
                      <div class="col-sm-10">
                        <input type="number" class="form-control" required="required" placeholder="Input Amount of rain . . . " name="arain">
                      </div>
                    </div>
					<div class="form-group row">
                      <label class="col-sm-6 form-control-label">Storm Signal</label>
                      <div class="col-sm-10">
                        <input type="number" class="form-control" required="required" placeholder="Input Storm Signal . . . " name="ss_signal">
                      </div>
                    </div>
                    <div class="line"></div>	
