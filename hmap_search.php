...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA5R6JEIiERVxCgYhl9gsGZ8GOUvnifjO4" type="text/javascript"></script>
    ...
    function load() {
      var map = new google.maps.Map(document.getElementById("map"), {
        ...
        echo "center: new google.maps.LatLng(".$longlat.")";?>,
  ...
  // [END snippet]
      ...
      downloadUrl("xmllandslide.php", function(data) { 
        ...
        for (var i = 0; i < markers.length; i++) {
		  ...
		  var tpreg = markers[i].getAttribute("tpreg");
		  var tkid = markers[i].getAttribute("tkid");
		  var telder = markers[i].getAttribute("telder");
		  var tmale = markers[i].getAttribute("tmale");
		  var tfemale = markers[i].getAttribute("tfemale");
		  var link1 = markers[i].getAttribute("link1");
          var point = new google.maps.LatLng(
              parseFloat(markers[i].getAttribute("lat")),
              parseFloat(markers[i].getAttribute("lng")));
          var html = "Name: <b>" + name + "</b> <br/>Address:" + address  + "<br/> Type:" + type  + " <br/># of Evacuee:" + tevac + " <br/># of Pregnant:" + tpreg + " <br/># of below 18 y/o:" + tkid +  " <br/># of Elderly:" + telder + " <br/># of Male:" + tmale +  "<br/># of Female:" + tfemale + "<br/>Capacity:" + capacity +" <br/><p><a href='" + link1 + "'>View The Information</a></p>"; 
      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="admin-menu">
          <ul id="side-admin-menu" class="side-menu list-unstyled"> 
			<li class="active"> <a href="hmap.php"> <i class="icon-picture"> </i><span>Landslide Map</span></a></li>
          </ul>
        </div>
      </div>
    </nav>
      ...
      <div class="breadcrumb-holder">   
        <div class="container-fluid">
		  ...
		  <div class="col-lg-10">
                            ...
                            <form action="hmap_search.php" method="POST">
                                <label class="col-sm-6">
								Select Evacuation Center
								<select class="form-control display" placeholder="Search Evacuation Center on map . . . " name="longlat">
								<?php
					$sqlsr = "SELECT * FROM evacuation_center order by ec_id";
					$resultsr = $conn->query($sqlsr);
					if ($resultsr->num_rows > 0) {
						while($rowsr = $resultsr->fetch_assoc()) {
							$long=$rowsr['longitude'];
							$lat=$rowsr['latitude'];
							$evacname=$rowsr['evacuation_name'];
							$ec_id=$rowsr['ec_id'];
							echo "<option value='".$lat.",".$long."' >".$evacname."</option>";
					...
					?>
								...
								<input type="submit" class="btn btn-success" value="Search Evacuation">
								</form>
      ...
      <section class="charts">
        <div class="container-fluid">
          <header> 
					...
					<br/>
			<h1 class="h3" align="center">CAMALIG ALBAY Hazard Map</h1>
			<?php echo "$long $lat";?>
          </header>
          <div class="row">
            <div class="col-lg-12">
