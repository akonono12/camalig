...
<html>
  <head>
    ...
    <title>NDRRMC Tabaco - Storm Report</title>
  ...
  <body>
      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li class="active"> <a href="charts.html"><i class="icon-presentation"></i><span>Manage Report</span></a></li>
        ...
        <div class="admin-menu">
          <ul id="side-admin-menu" class="side-menu list-unstyled"> 
            <li> <a href=""> <i class="icon-picture"> </i><span>Storm Map</span></a></li>
			<li> <a href=""> <i class="icon-picture"> </i><span>Landslide Map</span></a></li>
          </ul>
        </div>
      </div>
    </nav>
    <div class="page home-page">
      ...
      <div class="breadcrumb-holder">   
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="report.php">Landslide report</a></li>
			<li class="breadcrumb-item active">Storm Report</li>
      ...
      <section class="charts">
        <div class="container-fluid">
          <header> 
            <h1 class="h3">Camalig Albay Weather Report</h1>  <b class="btn btn-success"><a href="report_graph.php" style="color:white">View Graph</a></b>
          </header>
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header d-flex align-items-center">
                  <h2 class="h5 display">Storm Surge Signal Report for the year <?php echo date('Y');?></h2>
                </div>
                <div class="card-body">
                  <table class="table table-striped table-hover">
                    ...
                    <tbody>
                      <?php
												$sql = "SELECT * FROM disaster_report order by date_added desc";
												...
												if ($result->num_rows > 0) {
													...
													while($row = $result->fetch_assoc()) {
														$brgy=$row['barangay'];
														echo "<tr align='center'> <td>".$count."</td>";
														echo "<td width='300px' style='text-align:center;'>Storm</td><td width='300px' style='text-align:center;'>Signal #".$row['ss_signal']."</td><td width='300px' style='text-align:center;'>".$row['date_added']."</td>";
														$count++;
													}
												} 
												else{
